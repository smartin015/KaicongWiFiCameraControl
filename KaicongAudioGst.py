...
class KaicongAudioSource(gst.BaseSrc):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.audio = KaicongAudio(kwargs["ip"])
        self.audio.connect()
...
if __name__ == "__main__":
  ...
  pipeline_str = 'kaicongaudiosrc ip=%s ! audioconvert ! audioresample ! autoaudiosink'
  pipeline = gst.parse_launch(pipeline_str % (sys.argv[1]))
